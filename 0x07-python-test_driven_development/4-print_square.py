...
def print_square(size):
        """ This function prints a square with the character '#'. It takes as a paramet 'size' => which is a non-negative integer and uses the symbol to represent the square,accordingly Then returns 'None'. """
